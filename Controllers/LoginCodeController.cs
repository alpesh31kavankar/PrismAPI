...
{
    public class LoginCodeController : ApiController
    {
        // GET: LoginCode
        ...
        public async Task<IHttpActionResult> SaveLoginCodeImage(int Id)
        {
            try
            {
                ...
                foreach (var file in provider.Contents)
                {
                    ...
                    File.WriteAllBytes(theDirectory + "/Content/LoginCode" + "/" + Id + "_" + newFilename, buffer);   // content folder
