...
namespace PrismAPI.Controllers
{
    public class ContactController : ApiController
    {
        ...
        {
            Log.writeMessage("ContactController GetAllContact Start");
            List<Contact> list = null;
            try
            {
                list = contactDAL.GetAllContact();
            }
            catch (Exception ex)
            {
                Log.writeMessage("ContactController GetAllContact Error " + ex.Message);
            }
            Log.writeMessage("Contactontroller GetAllContact End");
            return list;
        }
        [HttpGet]
        ...
        {
            Log.writeMessage("ContactController GetContactById Start");
            Contact contact = null;
            try
            {
                contact = contactDAL.GetContactById(Id);
            }
            catch (Exception ex)
            {
                Log.writeMessage("ContactController GetContactById Error " + ex.Message);
            }
            Log.writeMessage("ContactController GetContactById End");
            return contact;
        }
        ...
        public IHttpActionResult AddContact(Contact contact)
        {
            ...
            try
            {
                ...
                contact.CreatedDate = DateTime.Now.ToString("MM/dd/yyyy");
                contact.UpdatedBy = "Admin";
                //contact.Status = "Success";
                contact.UpdatedDate = DateTime.Now.ToString("MM/dd/yyyy");
                result = contactDAL.AddContact(contact);
            ...
            {
                Log.writeMessage("ContactController AddContact Error " + ex.Message);
            }
            return Ok(result);
        }
        ...
        public IHttpActionResult UpdateContacty(Contact contact)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                var result = contactDAL.UpdateContact(contact);
            ...
            {
                Log.writeMessage("FirstController UpdateCity Error " + ex.Message);
            }
            return Ok("Failed");
        }
        ...
        public IHttpActionResult DeleteContact(int Id)
        {
            try
            {
                var result = contactDAL.DeleteContact(Id);
            ...
            {
                Log.writeMessage("ContactController DeleteContact Error " + ex.Message);
            }
            return Ok("Failed");
        }
